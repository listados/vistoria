 ...
 */
	...
	static public function countImage($survey_id){
	 ...
	 */
	static public function verifyUserExist($array_user)
	{
	...
	static public function addOrderAmbienceSurvey($id_survey)
	{
	...
	static public function getOrderAmbienceSurvey($list)
	{
	...
	static public function converterOrdertoString($list)
	{
		$list_id = []; //PARA CRIAR UM ARRAY
		foreach ($list as $key => $value) {
			array_push($list_id, $value->files_ambience_id_ambience);//PREENCHENDO UM ARRAY
